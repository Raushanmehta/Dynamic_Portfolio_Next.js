...
export default function Footer({ }: Props) {
  ...
  return (
    ...
    <footer className="text-white body-font w-full " >
      <div className="footer_section py-4 bg-black px-8">
          ...
          <div className="footer_section_2">
            <div className="flex flex-wrap lg:mx-20">
              <div className="w-full lg:w-1/4 sm:w-1/2 mt-6">
                ...
                <p className="mt-5">Bihar Patna 800008 </p>
                <div className=" hover:text-purple-900"><a href="9304137746">(+91) 9304137746</a></div>
                <div className=" hover:text-purple-900"><a href="try.raushanmehta2184@gmail.com">try.raushanmehta@gmail.com</a></div>
              </div>
              ...
              <div className="w-full lg:w-1/4 sm:w-1/2  lg-p-4 mt-6">
                ...
                <div className="form-group mt-5">
                  ...
                  <div className="mt-2"><a href="#" className="inline-block px-4 py-2
      ...
      <div className="bg-black">
        <div className="md:p-3 p-5  md:mx-40  flex items-center sm:flex-row flex-col">
          <a className="flex title-font  font-medium items-center md:justify-start justify-center text-gray-900">
            <Image src={"/assets/Logo.png"} alt='logo' width={150}
              height={150} />
          </a>
          <p className="text-sm text-gray-500 sm:ml- justify-center items-center sm:mt-2 p-2">Copyright © Code Learning
